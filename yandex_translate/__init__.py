...
class YandexTranslate(object):
    ...
    def __init__(self, key=None):
        ...
        self.api_urls = {
            'langs': 'http://translate.yandex.net/api/v1.5/tr.json/getLangs?%s',
            'detect': 'http://translate.yandex.net/api/v1.5/tr.json/detect?%s',
            'translate': 'http://translate.yandex.net/api/v1.5/tr.json/'
            'translate?%s',
        }
        if not key:
